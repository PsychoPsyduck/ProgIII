...
class Pedido
{
    ...
    public static function Registrar($id_mesa, $id_menu, $id_mozo, $nombre_cliente)
    {
        ...
        try {
            ...
            if ($validacion[0] >= 0) {
                ...
                return array("Estado" => "OK", "Mensaje" => "Pedido registrado correctamente.");
            } else {
                return array("Estado" => "ERROR", "Mensaje" => "Alguno de los ID ingresados es invalido.");
            }
        } catch (Exception $e) {
    ...
    public static function Cancelar($codigo)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Pedido cancelado correctamente.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
    ...
    public static function TomarPedido($codigo, $id_encargado, $minutosEstimadosDePreparacion)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Pedido tomado correctamente.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
    ...
    public static function InformarListoParaServir($codigo)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Pedido listo para servir.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
    ...
    public static function Servir($codigo)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Pedido servido correctamente.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
    ...
    public static function TiempoRestante($codigo)
    {
        try {
            ...
            if($pedido["estado"] == 'En Preparacion'){
                ...
                return array("Estado" => "ERROR", "Mensaje" => "El pedido se encuentra ".$pedido["estado"]);
            }
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
    ...
    public static function Finalizar($codigoMesa)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Pedidos de la mesa finalizados correctamente.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
