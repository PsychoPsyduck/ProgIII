...
class mesa
{
    ...
    public static function Baja($codigo)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Mesa eliminada correctamente.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
    ...
    public static function ActualizarFoto($rutaFoto, $codigoMesa)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Foto actualizada correctamente.");
        } catch (Exception $e) {
    ...
    public static function Cobrar($codigoMesa)
    {
        try {
            ...
            return array("Estado" => "OK", "Mensaje" => "Se ha cobrado a la mesa con exito.");
        } catch (Exception $e) {
            $mensaje = $e->getMessage();
            return array("Estado" => "ERROR", "Mensaje" => "$mensaje");
        }
